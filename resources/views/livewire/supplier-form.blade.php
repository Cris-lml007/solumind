<div>
        ...
        <form>
            ...
            <div class="d-flex">
                ...
                <div style="width: 50%; margin-left: 10px;">
                    ...
                    <input type="tel" name="cellular" class="form-control mb-3" placeholder="Ingrese número de celular">
                </div>
            </div>
            ...
            <div class="d-flex">
                <div style="width: 50%;">
                    ...
                    <input type="email" name="email-corporation" class="form-control mb-3" placeholder="Ingrese correo">
                ...
                <div style="width: 50%; margin-left: 10px;">
                    ...
                    <input type="text" name="nit" class="form-control mb-3"
                                                  placeholder="Ingrese numbre de organización">
    ...
    <div class="modal-footer">
        <button class="btn btn-primary" wire:click="show">Guardar</button>
