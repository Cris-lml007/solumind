...
<div>
    ...
    <div class="modal-body">
        ...
        <div class="input-group">
            <select name="searchable-item" id="searchable-item" class="form-select" wire:model.live="searchable_item">
                <option>selecione un cliente</option>
                @foreach ($clients as $item)
                    <option value="{{ $item->id }}">{{ $item->organization . ' (' . $item->person->name . ')' }}
                    </option>
                @endforeach
            </select>
        ...
        @if ($contract->id != null)
            <div>
                <hr>
                <div class="mb-3 d-flex justify-content-between py-0">
            ...
            <x-modal id="modal-partner" title="Añadir Inversión" class="modal-lg">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" wire:click="saveInversion">Guardar</button>
                ...
                <div class="modal-body">
                        ...
                        <div class="w-50">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control mb-3"
                                    placeholder="Ingrese codigo de producto" wire:model.live="code_product">
                    ...
                    <div class="d-flex">
                        <div class="col-4 ps-0 pe-0">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control mb-3" name="purchase-price"
                        ...
                        <div class="col-4 ms-0 ps-1 pe-0">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control mb-3" name="sale-price"
                                    placeholder="Ingrese precio de Venta" wire:model.lazy="sale_price">
                                <span class="input-group-text" style="height: 38px;">Bs</span>
                            </div>
                        </div>
                        <div class="col-4 pe-0 ms-0 ps-1">
                            ...
                            <input type="number" class="form-control mb-3" name="sale-price"
                                placeholder="Ingrese cantidad" wire:model.lazy="quantity">
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="description">Descripción</label>
                    ...
                    <div class="d-flex">
                        <div class="w-50">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" type="number" name="operating"
                                    wire:model.lazy="operating">
                                <span class="input-group-text">%</span>
                        ...
                        <div class="w-50 ms-1">
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control" type="number" name="comission"
                                    wire:model.lazy="comission">
                                <span class="input-group-text">%</span>
